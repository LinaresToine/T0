            ...
            if streamConfig.ProcessingStyle == "Bulk":
                ...
                for rawSkim in datasetConfig.RawSkims:
                    ...
                    outputModuleDetails.append( { 'dataTier' : dataTier,
                                                  ...
                                                  'parentDataset' : dataset, # parameter "moduleLabel" (in wmcore) in output modules does not support the "-" in the name, so we introduce parentDataset to leave primaryDataset alone 
                                                  'rawSkim' : rawSkim } )
